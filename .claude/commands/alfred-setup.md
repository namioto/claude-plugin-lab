...
5. **설정 저장**
   ...
   printf '\033[33m     ~/.claude/agent-memory/jira/\033[0m\n'
   printf '\033[33m     ~/.claude/agent-memory/confluence/\033[0m\n'
   printf '\033[33m     ~/.claude/agent-memory/jsm/\033[0m\n'
   printf '\033[33m     ~/.claude/agent-memory/jpd/\033[0m\n'
   printf '\n'
